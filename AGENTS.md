...
- **Focus:** 
    ...
    - Electronic Signature (Bouncy Castle CMS/PKCS#7) and PDF conversion logic.
    - Local file storage and JPA persistence.
...
- **Focus:** 
    - Docker Compose orchestration (PostgreSQL, Mailpit, LibreOffice).
...
| **Backend** | Java 17+, BPMN, Signature APIs | Spring Boot 3.x, Hibernate, Bouncy Castle, JODConverter |
