...
import es.tfm.records.infrastructure.persistence.repository.PublicContentEntryJpaRepository;
...
public class DataInitializer {
    ...
    CommandLineRunner initDevData(PasswordEncoder passwordEncoder,
                                  ...
                                  es.tfm.records.infrastructure.persistence.repository.UserJpaRepository userJpaRepo) {
        return args -> {
