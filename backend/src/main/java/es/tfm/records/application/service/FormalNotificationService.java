...
public class FormalNotificationService {
    ...
    @Transactional(readOnly = true)
    public es.tfm.records.application.dto.PagedResponse<FormalNotificationDtos.AdminNotificationItem> listAllNotifications(
        ...
        return new es.tfm.records.application.dto.PagedResponse<>(
