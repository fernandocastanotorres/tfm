...
import es.tfm.records.application.service.DocumentService;
...
import es.tfm.records.entrypoints.controller.BackofficeController;
...
class BackofficeControllerTest {
    ...
    void upsertFieldTranslation_shouldReturnBadRequestOnMissingFields() throws Exception {
        ...
        when(backofficeService.upsertFieldTranslation(eq(procId), any()))
                .thenThrow(new es.tfm.records.application.exception.ValidationException(
