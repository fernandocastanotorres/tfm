...
import es.tfm.records.infrastructure.mailing.EmailVerificationMessage;
import es.tfm.records.infrastructure.mailing.NewMessageNotificationMessage;
import es.tfm.records.infrastructure.mailing.VerificationEmailConsumer;
