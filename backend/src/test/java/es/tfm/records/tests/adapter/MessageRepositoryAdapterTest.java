...
import es.tfm.records.infrastructure.persistence.adapter.MessageRepositoryAdapter;
import es.tfm.records.infrastructure.persistence.entity.MessageEntity;
import es.tfm.records.infrastructure.persistence.repository.MessageJpaRepository;
