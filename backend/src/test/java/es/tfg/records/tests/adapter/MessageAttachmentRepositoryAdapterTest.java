...
import es.tfg.records.infrastructure.persistence.adapter.MessageAttachmentRepositoryAdapter;
import es.tfg.records.infrastructure.persistence.entity.MessageAttachmentEntity;
import es.tfg.records.infrastructure.persistence.repository.MessageAttachmentJpaRepository;
